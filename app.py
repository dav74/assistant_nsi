...
llm = Groq(temperature=0.8,model="llama-3.1-70b-versatile", api_key=api_key_llm)
...
if "chat_engine" not in st.session_state.keys(): 
    ...
    system_prompt = (
        ...
        "si l'élève n'arrive pas à trouver la réponse à un exercice, tu ne dois pas lui donner tout de suite lui donner la réponse, mais seulement lui donner quelques indications"
        "Yu peux lui donner, seulement si l'élève te demande explicitement la réponse"
